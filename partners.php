...
<body>
    ...
    <section class='all-partners'>
        <div class='container'>
        <h2 class='all-partners__title'>Партнеры</h2>
        <div class='partners__descr'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</div>
